...
### H5 — Prevención de errores (3 → 8) ★ Mayor mejora
...
### H10 — Ayuda y documentación (2 → 8) ★ Mayor mejora absoluta
...
> **Nota:** esta evaluación es parte del trabajo académico de fin de máster en Sistemas Inteligentes, Universidad de Salamanca, 2025–2026. PosturePilot no es un dispositivo médico ni proporciona asesoramiento clínico.
