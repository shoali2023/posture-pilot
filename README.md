...
│
├── docs/
│   ├── branding/                  # Logo assets, color palette, usage guide
│   ├── report/
...
A full manual QA checklist is at `docs/testing/manual-qa-checklist.md`. It covers:
...
analytics rendering, clear data, branding, favicon, and privacy.

---

## Screenshots

> Screenshots will be added after final manual QA pass.

| Description | Path |
|---|---|
| Welcome screen | `docs/screenshots/01-welcome-screen.png` |
| Home dashboard | `docs/screenshots/02-home-dashboard.png` |
| Live Check — good posture | `docs/screenshots/03-live-check-good-posture.png` |
| Live Check — warning state | `docs/screenshots/04-live-check-warning-state.png` |
| Reminder checklist | `docs/screenshots/07-reminder-checklist.png` |
| Analytics dashboard | `docs/screenshots/08-analytics-dashboard.png` |
| Calibration panel | `docs/screenshots/09-calibration-panel.png` |
...
- `competitive-gap-analysis.md` — competitor landscape and differentiation
